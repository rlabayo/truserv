    ...
    <div class="row col-lg-12">
        <div class="col-xs-12" id="create-div-1">
            <div class="panel panel-info">
                <div class="panel-heading">Principal Korean</div>
                <div class="panel-body">
                    <div class="table-responsive col-lg-12" ng-controller="koreanTableController">
                                ...
                                echo "
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type=\"button\" class=\"btn btn-default view\" data-toggle=\"modal\" ng-click = 'viewDependents(".$item['id'].")' title=\"View Dependent\">
                    ...
                    <form id="editForm" class="form-horizontal" name="editForm" >
                        ...
                        <table class="table table-bordered" >
                            ...
                            <tr>
                                ...
                                <td><input type="number" class="form-control textbox_num" id="edit_personal_number" ng-model ="edit_personal_number" name="edit_personal_number" aria-describedby="edit_personal_number_Help" placeholder="Personal Number" ng-change = "editPersonalNumberChange()" required />
                                <input type="hidden" class="form-control" id="edit_personal_number_hidden" name="edit_personal_number_hidden" aria-describedby="edit_personal_number_hidden_Help" placeholder="Personal Number" required ng-model="edit_personal_number_hidden" /></td>
                            </tr>
                            <tr>
                                <td>Folder Name</td>
                                <td>
                            ...
                            <tr>
                                <td>Gender</td>
                                <td>
                                    <select class="form-control" id="edit_gender" name="edit_gender" ng-model="edit_gender" required>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" id="edit_contact_number" name="edit_contact_number" aria-describedby="edit_contact_number_Help" placeholder="Contact Number" ng-model="edit_contact_number" required /></td>
                            </tr>
                            <tr>
                                <td>Petitioner</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control datePicker" id="edit_visa_issue_date" placeholder="Visa Issue Date" name="edit_visa_issue_date" autocomplete="off"  value="" data-date-format="yyyy-mm-dd" ng-model="edit_visa_issue_date"/></td>
                            </tr>
                            <tr>
                                <td>Others<br>(Please Specify)</td>
                                <td><input type="text" class="form-control" id="edit_others" name="edit_others" aria-describedby="edit_others_Help" placeholder="Others" ng-model="edit_others" /></td>
                            </tr>
                            <tr>
                                <td>Principal Name <br>[First Name first]</td>
                                <td><input type="text" class="form-control" id="edit_principal_name" name="edit_principal_name" aria-describedby="pedit_rincipal_name_Help" placeholder="Principal Name" required ng-model="edit_principal_name" /></td>
                            </tr>
                            <tr>
                                <td>Passport Number</td>
                                <td><input type="text" class="form-control" id="edit_passport_number" name="edit_passport_number" aria-describedby="edit_passport_number_Help" placeholder="Passport Number" ng-model="edit_passport_number" /></td>
                            </tr>
                            <tr>
                                <td>Birthdate</td>
                                <td><input type="text" class="form-control datePicker" id="edit_birthdate" placeholder="Birthdate" name="edit_birthdate" autocomplete="off"  value="" data-date-format="yyyy-mm-dd" ng-model="edit_birthdate" /></td>
                            </tr>
                            <tr>
                                <td>Visa Valid Until</td>
                                <td><input type="text" class="form-control datePicker" id="edit_visa_valid_until" placeholder="Visa Valid Until" name="edit_visa_valid_until" autocomplete="off"  value="" data-date-format="yyyy-mm-dd" ng-model="edit_visa_valid_until" /></td>
                            </tr>
                            <tr>
                                <td>Visa Status</td>
                                <td>
                    ...
                    <form id="addForm" class="form-horizontal" name="addForm" >
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>Personal Number</td>
                                <td>
                                    <input type="number" ng-model="personal_number" class="form-control textbox_num" id="personal_number" name="personal_number" aria-describedby="personal_number_Help" placeholder="Personal Number" ng-change="addPersonalNumberChange()" required />
                                    <span ng-show="addForm.personal_number.$error.number">Not a valid number!!</span>
                                </td>
                            </tr>
                            <tr>
                                <td>Folder Name</td>
                            ...
                            <tr>
                                <td>Contact Number</td>
                                <td>
                                    <input type="text" class="form-control" ng-model="contact_number" id="contact_number" name="contact_number" aria-describedby="contact_number_Help" placeholder="Contact Number" required />
                                </td>
                            </tr>
                            <tr>
                                <td>Petitioner</td>
                                ...
                                <!--td><input type="text" class="form-control" ng-model="petitioner" id="petitioner" name="petitioner" aria-describedby="petitioner_Help" placeholder="Petitioner" required /></td-->
                            </tr>
                            <tr>
                                <td>Visa Issue Date</td>
                                <td><input type="text" class="form-control datePicker" ng-model="visa_issue_date" id="visa_issue_date" placeholder="Visa Issue Date" name="visa_issue_date" autocomplete="off"  value="<?php echo date('Y-m-d'); ?>" data-date-format="yyyy-mm-dd"  /></td>
                            </tr>
                            <tr>
                                <td>Others<br>(Please Specify)</td>
                                <td><input type="text" class="form-control" ng-model="others" id="others" name="others" aria-describedby="others_Help" placeholder="Others" /></td>
                            </tr>
                            <tr>
                                <td>Principal Name <br>[First Name first]</td>
                                <td><input type="text" class="form-control" ng-model="principal_name" id="principal_name" name="principal_name" aria-describedby="principal_name_Help" placeholder="Principal Name" required /></td>
                            </tr>
                            <tr>
                                <td>Passport Number</td>
                                <td><input type="text" class="form-control" ng-model="passport_number" id="passport_number" name="passport_number" aria-describedby="passport_number_Help" placeholder="Passport Number" /></td>
                            </tr>
                            <tr>
                                <td>Birthdate</td>
                                <td><input type="text" class="form-control datePicker" ng-model="birthdate" id="birthdate" placeholder="Birthdate" name="birthdate" autocomplete="off"  value="<?php echo date('Y-m-d'); ?>" data-date-format="yyyy-mm-dd" /></td>
                            </tr>
                            <tr>
                                <td>Visa Valid Until</td>
                                <td><input type="text" class="form-control datePicker" ng-model="visa_valid_until" id="visa_valid_until" placeholder="Visa Valid Until" name="visa_valid_until" autocomplete="off"  value="<?php echo date('Y-m-d'); ?>" data-date-format="yyyy-mm-dd" /></td>
                            </tr>
                            <tr>
                                <td>Visa Status</td>
                                <td>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Do you really want to delete the item? All the dependents of the primary will be deleted also.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
                    <button type="button" id="yes" class="btn btn-primary" ng-click="deleteKorean()">Yes</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    koreanApp.controller('koreanTableController', function($scope){
       // var editModalScope = angular.element('#editModal').scope();
       // editModalScope.edit_personal_number
        ...
        $scope.viewDependents = function(id){
            window.location.assign("<?php echo base_url(); ?>index.php/korean/viewDependent/"+id);
        }
    });
    ...
    koreanApp.controller('addKoreanController', function($scope){
        $scope.addPersonalNumberChange = function(){
            $.ajax({
                ...
                data: { 'pno' : $scope.personal_number },
                dataType: 'json',
        ...
        $scope.submitData = function(){
            if( $('#personal_number').val() == '' ){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>index.php/korean/addPrimary",
                    data: {
    ...
    koreanApp.controller('deleteKoreanController', function($scope){
        $scope.deleteKorean = function() {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>index.php/korean/deletePrimary",
