...
<div id="wrapper" ng-app="otherApp">
        <div class="row col-lg-12">
            <div class="col-xs-12" id="create-div-1">
                <div class="panel panel-info">
                    <div class="panel-heading">Principal Others</div>
                    <div class="panel-body">
                        <div class="table-responsive col-lg-12" ng-controller="otherTableController">
                                    ...
                                    echo "
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <!--button type=\"button\" class=\"btn btn-default view\" data-toggle=\"modal\" ng-click = \"window.open('viewOtherDependent/".$item['id']."', '_blank')\" title=\"View Dependent\">
        ...
        <!--Modal-->
        <div class="modal bs-example-modal-lg" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" ng-controller="editOtherController">
                        ...
                        <form id="editForm" class="form-horizontal">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" id="edit_principal_name" name="edit_principal_name" aria-describedby="pedit_rincipal_name_Help" placeholder="Principal Name" required /></td>
                                </tr>
                                <tr>
                                    <td>Gender</td>
                                    <td>
        ...
        <div class="modal bs-example-modal-lg" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" ng-controller="addOtherController">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    ...
                    <div class="modal-body">
                        <form id="addForm" class="form-horizontal">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>Principal Name <br>[First Name first]</td>
                                    <td><input type="text" class="form-control" id="principal_name" name="principal_name" aria-describedby="principal_name_Help" placeholder="Principal Name" required /></td>
                                </tr>
                                <tr>
                                    <td>Gender</td>
                                    <td>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        <button type="button" ng-click="submitData()" class="btn btn-primary">Save changes</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal bs-example-modal-lg" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" ng-controller="deleteOtherController">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script>
    otherApp = angular.module('otherApp', []);

    otherApp.controller('otherTableController', function($scope){
        ...
        $scope.viewDependents = function(id){
            window.location.assign("<?php echo base_url(); ?>index.php/other/viewOtherDependent/"+id);
        }   
    });

    otherApp.controller('editOtherController', function($scope){
    ...
    otherApp.controller('addOtherController', function($scope){
        $scope.submitData = function(){
            if( $('#passport_number').val() == '' ){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>index.php/other/addPrimary",
                    data: {
    ...
    otherApp.controller('deleteOtherController', function($scope){
